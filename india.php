    ...
    <div class="container gallery-project">
        <div class="row">
            ...
            <div class="col-md-4 section-hook">
                ...
                <h4>
                    <em>
                        <a href="http://www.id4learning.com/laxmi.html" target="_blank">Web</a>
                    </em>
                </h4>
                <p>
                    A piece of the
        ...
        <div class="row">
            <div class="col-md-8">
                <img src="/images/india/screenshot.png" />
            </div>
            <div class="col-md-4">
                <p>
                    <em>
        ...
        <div class="row">
			<div class="col-md-4 col-md-push-4 bottom-finish">
				<a class="btn btn-default" href="https://github.com/Cryclops/IndiaTablet" target="_blank">
					<img class="btn-icon" src="/images/GitHub-Mark-32px.png"/> Source on GitHub
				</a>
			</div>
		</div>
    </div>
